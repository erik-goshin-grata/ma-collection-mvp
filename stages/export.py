...
_COLUMNS = [
    ...
    "equity_value", "implied_equity_value", "implied_enterprise_value", "implied_enterprise_value_basis",
    "transaction_value", "transaction_value_basis", "deal_value_currency",
...
def run(conn: sqlite3.Connection, cfg: Config, run_id: str) -> dict:
    ...
    rows = conn.execute(
        ...
        SELECT
            ...
            tr.equity_value, tr.implied_equity_value, tr.implied_enterprise_value, tr.implied_enterprise_value_basis,
            tr.transaction_value, tr.transaction_value_basis, tr.deal_value_currency,
